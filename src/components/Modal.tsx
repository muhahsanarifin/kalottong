...
export const LogoutModal: React.FC<LogoutModalProps> = ({
  ...
  return (
    <>
      <div className=" flex fixed top-0 left-0 right-0 h-[100vh] flex-col items-center justify-center bg-transparant pt-4 z-50 border-2 border-solid border-green-500">
